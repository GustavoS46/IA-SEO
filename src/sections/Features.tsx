...
const tabs = [
  ...
  },
  {
    ...
    title: "Otimização com um clique",
    isNew: false,
  ...
  },
  {
    ...
    title: "Gerador de palavras-chave inteligente",
    isNew: true,
...
const handleTabHover = () => {
  ...
  return (
    ...
    >
      ...
      {props.isNew && <div className="text-xs rounded-full px-2 py-0.5 bg-[#8C44FF] text-black font-semibold">novo</div>}
    </div>
  )
}
  ...
  return (
    <section className="py-20 md:py-24">
      <div className="container">
        <h2 className="text-5xl md:text-6xl max-w-2xl mx-auto font-medium text-center tracking-tighter">Elevando saus habilidades de SEO.</h2>
        <p className="text-white/70 text-lg tracking-tight text-center mt-5">
          De pequenas startups a grandes empresas, nossa ferramenta acionada pela IA revolucionou a maneira como as empresas se aproximam do SEO.
        </p>
