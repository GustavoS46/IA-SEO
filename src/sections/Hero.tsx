...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Fim do anel 3 */}
      <div className="container relative mt-16 text-center">
        <h1 className="text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text">IA SEO</h1>
        <p className="text-lg md:text-xl text-white/70 mt-5 max-w-xl mx-auto">
          Elevar a visibilidade do seu site sem esforço com a IA, onde a tecnologia inteligente atende às ferramentas de SEO fácil de usar.
        </p>
